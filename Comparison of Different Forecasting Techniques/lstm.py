...
class lstm_model():
  def __init__(self, lstm_units, timesteps_in, timesteps_out, num_features):
    self.lstm_units = lstm_units
    self.dropout_rate = 0.2
    self.timesteps_in = timesteps_in
    self.timesteps_out = timesteps_out
    self.num_features = num_features
    self.weights_dir = "/content/drive/My Drive/Colab/Research - EE5003/Phase 1 - Comparison of forecasting technique/Model Weights/lstm.h5py"
    self.epochs = 20
    self.batch_size = 64
    self.create_model()
